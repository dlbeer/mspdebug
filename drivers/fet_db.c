...
static const struct fet_db_record fet_db[] = {
	...
	{ /* Copied from MSP430F5529 */
		.name = "MSP430F5329",
		.msg28_data = {
			0x1b, 0x81, 0x15, 0x12, 0x08, 0x0a, 0x67, 0xd9,
			0xb4, 0x46, 0xb6, 0x07, 0xd5, 0x0f, 0xf8, 0xfe,
			0x19, 0x02
	...
	{ /* Copied from MSP430F5529, with modifications */
		.name = "MSP430F5342",
		.msg28_data = {
			0x1e, 0x81, 0x15, 0x12, 0x08, 0x0a, 0x67, 0xd9,
			0xb4, 0x46, 0x0a, 0x0f, 0x0d, 0x02, 0xf8, 0xfe,
			0x00, 0x00
	...
	{ /* Copied from MSP430F2272, with changes to ID info */
		.name = "MSP430F2252",
		.msg28_data = {
			0xf2, 0x27, 0x80, 0xa0, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x02, 0x02, 0x01, 0x04, 0x71, 0x81,
			0x85, 0x00
			/* extra: 89 00 00 00 00 00 00 00 */
		},
		.msg29_params = {0x00, 0x39, 0x31},
	...
	{ /* Copied from MSP430G2452 with flash origin modifications */
		.name = "MSP430G2352",
		.msg28_data = {
			0x24, 0x52, 0x00, 0xa0, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
	...
	{ /* Copied from MSP430G2453, with modifications */
	       .name = "MSP430G2955",
	       .msg28_data = {
	...
	{ /* Copied from MSP430FR5739, with different ID data */
		.name = "MSP430FR5729",
		.msg28_data = {
			0x7b, 0x80, 0x24, 0x24, 0x08, 0x0a, 0x88, 0xf7,
			0xa2, 0x04, 0x49, 0x00, 0x0f, 0x00, 0xf8, 0xfe,
			0x7f, 0xd7,
			/* extra: 91 06 11 00 1a 00 04 05 */
		},
		.msg29_params = {0x00, 0xab, 0xa3},
	...
	{ /* From captured data */
		.name = "MSP430FR5728",
		.msg28_data = {
			0x7a, 0x80, 0x24, 0x24, 0x08, 0x0a, 0x67, 0x99,
			0x5b, 0x03, 0x18, 0x00, 0x0b, 0x00, 0xf8, 0xfe,
			0xf7, 0xbf
			/* extra: 91 06 11 00 1a 00 04 05 */
		},
		.msg29_params = {0x00, 0xab, 0xa3},
	...
	{ /* Copied from MSP430F5329, with modifications */
		.name = "MSP430F6736",
		.msg28_data = {
			0x6c, 0x81, 0x10, 0x10, 0x08, 0x0a, 0x24, 0x6e,
			0x99, 0x46, 0x0c, 0x00, 0x0c, 0x00, 0xf8, 0xfe,
			0xff, 0xff
			/* extra: 91 06 11 00 1a 00 04 05 */
		},
		.msg29_params = {0x00, 0x8b, 0x83},
	...
	{ /* From USB capture */
		.name = "MSP430F6435",
		.msg28_data = {
			0x21, 0x81, 0x22, 0x11, 0x08, 0x0a, 0xb5, 0x14,
			0x98, 0x46, 0x22, 0x00, 0x19, 0x00, 0xf8, 0xfe,
			0x4d, 0x9d
			/* extra: 91 04 21 00 1a 00 04 05 */
		},
		.msg29_params = {0x0, 0x0106, 0xfe},
		.msg29_data = {
	...
	{ /* Based on MSP430F5527 */
		.name = "MSP430F5521",
		.msg28_data = {
			0x55, 0x21, 0x14, 0x12, 0x08, 0x0a, 0xca, 0xc0,
			0x8b, 0x46, 0x1e, 0x00, 0x1c, 0x00, 0xf8, 0xfe,
			0x61, 0xf4
			/* extra: 91 03 01 00 1a 00 04 05 */
		},
		.msg29_params = {0, 0x89, 0x81},
